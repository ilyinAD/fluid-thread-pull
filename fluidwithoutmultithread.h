...
#ifndef FLUIDTHREADPULL_FLUIDWITHOUTMULTITHREAD_H
#define FLUIDTHREADPULL_FLUIDWITHOUTMULTITHREAD_H
#include <bits/stdc++.h>
#include "Fixed.h"
#include "constants.h"
using namespace std;
...
//            return v[x][y][i];
    ...
    inline Fixed move_prob(int x, int y) {
        Fixed sum = 0;
...
#endif //FLUIDTHREADPULL_FLUIDWITHOUTMULTITHREAD_H
